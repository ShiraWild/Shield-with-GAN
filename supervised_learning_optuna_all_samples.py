...
for samples_path in update_samples_paths:
    try:
        with open(samples_path, 'rb') as file:
            ...
            all_samples.extend(trajectories)
...
def objective(trial):
    ...
    mini_batch_size = trial.suggest_categorical('mini_batch_size', [32, 64, 128, 256, 500])
...
study.optimize(objective, n_trials=20, n_jobs=1)  # Run 4 parallel jobs
